...
main() {
    local linux='https://cdn.kernel.org/pub/linux/kernel/v6.x/linux-6.2.10.tar.xz'
    local lxsha='57c562c3cd2753f232549cab05c8ad770ed848ae86401619c7581bdffaeea4fe'
